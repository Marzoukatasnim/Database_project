    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p> This website is to manage employees. </p>
        </header>
    </div>
    </section>
      ...
      <div class="container">
        ...
        <header class="section-header  wow fadeInUp">
          ...
          <p>Our Website Will Provide You a lot of services. Those are bellow.</p>
			<table align="center">
			<tr><td align="center"> 1. It will provide efficiency. </td></tr>
			<
			<tr><td align="center"> 2. It will provide Interactive User Interface.</td></tr>
			<tr><td align="center"> 3. Add And Remove Employee features.</td></tr>
			</table>
        </header>
      </div>
    </section>
            ...
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content" align="center">
                  ...
                  <div class="social">
                    <a href="https://twitter.com/mm"><i class="fa fa-twitter"></i></a>
                    <a href="https://www.facebook.commm"><i class="fa fa-facebook"></i></a>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+880">+880245678</a></p>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="https://www.gmail.com">muna@gmail.com </a></p>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Bangladesh <br>
              <strong>Phone:</strong> +880234567.<br>
              <strong>Email:</strong> muna@gmail.com .<br>
            </p>
